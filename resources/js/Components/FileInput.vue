<template>
    <div>
        <div class="form-input p-0 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" :class="{ error: errors.length }">
        ...
        <div v-if="errors.length" class="form-error text-red-500 mt-2 text-sm">{{ errors[0] }}</div>
    </div>
</template>
